...
public class WinningFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.winning_screen, container, false);

        savedInstanceState = this.getArguments();

        TextView message1 = v.findViewById(R.id.message1);
        TextView message2 = v.findViewById(R.id.message2);
        message1.setText("Congrats! The right word was: " + savedInstanceState.getString("word"));
        message2.setText("Your score is now: " + savedInstanceState.getInt("score"));
